...
Configuration.Modules.AbpAutoMapper().Configurators.Add(configuration =>
{
    ...
    // 只需要复制这一段
AbpExternalAuthenticateConfigMapper.CreateMappings(configuration);
...
```
Configuration.Authorization.Providers.Add<AbpExternalAuthenticateConfigAuthorizationProvider>();
...
可以在```DbContext```中增加：
 ...
 ```
public DbSet<AbpExternalAuthenticateConfig>  AbpExternalAuthenticateConfigs { get; set; }
...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new AbpExternalAuthenticateConfigCfg());
        }
...
<text name="AppName"  value="AppName"></text>
<text name="LoginProvider"  value="LoginProvider"></text>
<text name="AppId"  value="AppId"></text>
<text name="Secret"  value="Secret"></text>
<text name="IsEnabled"  value="IsEnabled"></text>


<text name="AbpExternalAuthenticateConfig" value=""></text><text name="QueryAbpExternalAuthenticateConfig"  value="查询"></text><text name="CreateAbpExternalAuthenticateConfig"  value="添加"></text><text name="EditAbpExternalAuthenticateConfig"  value="编辑"></text><text name="DeleteAbpExternalAuthenticateConfig"  value="删除"></text><text name="BatchDeleteAbpExternalAuthenticateConfig" value="批量删除"></text><text name="ExportAbpExternalAuthenticateConfig"  value="导出"></text>                             
