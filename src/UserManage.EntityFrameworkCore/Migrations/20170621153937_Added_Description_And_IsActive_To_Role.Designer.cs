...
namespace UserManage.Migrations
{
    ...
    partial class Added_Description_And_IsActive_To_Role
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("UserManage.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("UserManage.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("UserManage.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("UserManage.Authorization.Roles.Role", b =>
                {
                    b.HasOne("UserManage.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("UserManage.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("UserManage.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
